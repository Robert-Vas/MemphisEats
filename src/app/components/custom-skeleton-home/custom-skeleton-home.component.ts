...
@Component({
    selector: 'custom-skeleton-home',
    templateUrl: './custom-skeleton-home.component.html',
    styleUrls: ['./custom-skeleton-home.component.scss'],
})
export class CustomSkeletonHomeComponent {
    menuList = [
